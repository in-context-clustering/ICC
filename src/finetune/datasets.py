...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(
        ...
        self.is_text_only = [
            "image" not in source and "video" not in source and "number" not in source
    ...
    def __getitem__(self, i) -> Dict[str, List]:      
        ...
        if "image" in source:
            ...
            for image_path in image_sources:
                ...
                try: 
                    ...
                    print(i, 'ERROR reading image at ', image_path)
                    del self.list_data_dict[i]
                    if i >= self.__len__(): i = i - 1
        ...
        numbers = []
        if "number" in source:
            if isinstance(source["number"], list):
